...
public class scrMAzul : MonoBehaviour
{
    ...
    {
        if (outroGameObject.CompareTag("Player") && scriptGC.matrioskaAzul != true)
        {
        ...
        if (outroGameObject.CompareTag("Player") && scriptGC.matrioskaAzul == true)
        {
            ...
            matrioskas[1].transform.position = new Vector3(-4.04f, 4.61f, 0);
            scriptGC.MAzulCompleta = true;
